...
# 定义新的特征
def new_features(df):
    # Calculated the total area
    df['TotalArea'] = df['TotalBsmtSF'] + df['1stFlrSF'] + df['2ndFlrSF']

    # Calculated the number of new or renovated bathrooms
    df['NewBathrooms'] = df['FullBath'] + df['HalfBath']

    # Calculated the total room count
...
# print("linear_model_Score: ",r2_score(linear_model_predict,y_test))
...
# print("ridge_model_Score: ",r2_score(ridge_model_predict,y_test))
...
# print("lasso_model_Score: ",r2_score(lasso_model_predict,y_test))
...
print('Error: ', mean_absolute_error(y_test, voting_pred))
